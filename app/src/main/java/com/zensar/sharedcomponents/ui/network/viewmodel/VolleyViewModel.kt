package com.zensar.sharedcomponents.ui.network.viewmodel
...
import com.zensar.sharedcomponents.ui.network.fragment.VolleyFragment
import com.zensar.sharedcomponents.ui.network.utils.Constant
...
class VolleyViewModel(ctx: Fragment) : ViewModel() {
    ...
    fun getDataFromServer() {
        ...
        viewModelScope.launch {
            ...
            volleyInstance.getVolleyRequest(
